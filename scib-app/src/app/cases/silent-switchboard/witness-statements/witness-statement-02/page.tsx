      ...
      <div className="mx-auto w-full max-w-3xl">
        <header className="flex items-center justify-between gap-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">Cleaner statement transcript (stub)</p>
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/30 p-6 space-y-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4 text-sm text-slate-200">
            ...
            <div className="font-mono">.\src\app\cases\silent-switchboard\witness-statements\witness-statement-02\page.tsx</div>
          </div>
        </section>
      </div>
    </main>
